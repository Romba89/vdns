...
# Hosting
dugong="raw.githubusercontent.com/dugong-lewat/dugong-lewat/other"
cd /usr/bin
## Menu
wget -O menu "https://${dugong}/xray/menu/menu.sh"
wget -O vmess "https://${dugong}/xray/menu/vmess.sh"
wget -O vless "https://${dugong}/xray/menu/vless.sh"
wget -O trojan "https://${dugong}/xray/menu/trojan.sh"
wget -O shadowsocks "https://${dugong}/xray/menu/shadowsocks.sh"
wget -O shadowsocks2022 "https://${dugong}/xray/menu/shadowsocks2022.sh"
wget -O socks "https://${dugong}/xray/menu/socks.sh"
## Vmess
wget -O add-vmess "https://${dugong}/xray/vmess/add-vmess.sh"
wget -O del-vmess "https://${dugong}/xray/vmess/del-vmess.sh"
wget -O extend-vmess "https://${dugong}/xray/vmess/extend-vmess.sh"
wget -O trialvmess "https://${dugong}/xray/vmess/trialvmess.sh"
wget -O cek-vmess "https://${dugong}/xray/vmess/cek-vmess.sh"
## Vless
wget -O add-vless "https://${dugong}/xray/vless/add-vless.sh"
wget -O del-vless "https://${dugong}/xray/vless/del-vless.sh"
wget -O extend-vless "https://${dugong}/xray/vless/extend-vless.sh"
wget -O trialvless "https://${dugong}/xray/vless/trialvless.sh"
wget -O cek-vless "https://${dugong}/xray/vless/cek-vless.sh"
## Trojan
wget -O add-trojan "https://${dugong}/xray/trojan/add-trojan.sh"
wget -O del-trojan "https://${dugong}/xray/trojan/del-trojan.sh"
wget -O extend-trojan "https://${dugong}/xray/trojan/extend-trojan.sh"
wget -O trialtrojan "https://${dugong}/xray/trojan/trialtrojan.sh"
wget -O cek-trojan "https://${dugong}/xray/trojan/cek-trojan.sh"
## Shadowsocks
wget -O add-ss "https://${dugong}/xray/shadowsocks/add-ss.sh"
wget -O del-ss "https://${dugong}/xray/shadowsocks/del-ss.sh"
wget -O extend-ss "https://${dugong}/xray/shadowsocks/extend-ss.sh"
wget -O trialss "https://${dugong}/xray/shadowsocks/trialss.sh"
wget -O cek-ss "https://${dugong}/xray/shadowsocks/cek-ss.sh"
## Shadowsocks 2022
wget -O add-ss2022 "https://${dugong}/xray/shadowsocks2022/add-ss2022.sh"
wget -O del-ss2022 "https://${dugong}/xray/shadowsocks2022/del-ss2022.sh"
wget -O extend-ss2022 "https://${dugong}/xray/shadowsocks2022/extend-ss2022.sh"
wget -O trialss2022 "https://${dugong}/xray/shadowsocks2022/trialss2022.sh"
wget -O cek-ss2022 "https://${dugong}/xray/shadowsocks2022/cek-ss2022.sh"
## Socks5
wget -O add-socks "https://${dugong}/xray/socks/add-socks.sh"
wget -O del-socks "https://${dugong}/xray/socks/del-socks.sh"
wget -O extend-socks "https://${dugong}/xray/socks/extend-socks.sh"
wget -O trialsocks "https://${dugong}/xray/socks/trialsocks.sh"
wget -O cek-socks "https://${dugong}/xray/socks/cek-socks.sh"
## Log
wget -O log-create "https://${dugong}/xray/log/log-create.sh"
wget -O log-vmess "https://${dugong}/xray/log/log-vmess.sh"
wget -O log-vless "https://${dugong}/xray/log/log-vless.sh"
wget -O log-trojan "https://${dugong}/xray/log/log-trojan.sh"
wget -O log-ss "https://${dugong}/xray/log/log-ss.sh"
wget -O log-ss2022 "https://${dugong}/xray/log/log-ss2022.sh"
wget -O log-socks "https://${dugong}/xray/log/log-socks.sh"
## Other
wget -O xp "https://${dugong}/xray/other/xp.sh"
wget -O dns "https://${dugong}/xray/other/dns.sh"
wget -O certxray "https://${dugong}/xray/other/certxray.sh"
wget -O xraymod "https://${dugong}/xray/other/xraymod.sh"
wget -O xrayofficial "https://${dugong}/xray/other/xrayofficial.sh"
wget -O about "https://${dugong}/xray/other/about.sh"
## Chmod Vmess
chmod +x add-vmess
chmod +x del-vmess
