...
clear 
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo -e "               ${WB}----- [ VPSPLUS MULTI PORT -BY MAHBOUB-MILLON ] -----${NC}              "
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
...
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo -e "                ${WB}----- [ v2-ray Menu Multi ] -----${NC}               "
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo -e " ${MB}[1]${NC} ${YB}Vmess Menu${NC}          ${MB}[4]${NC} ${YB}Shadowsocks Menu${NC}      "
echo -e " ${MB}[2]${NC} ${YB}Vless Menu${NC}          ${MB}[5]${NC} ${YB}Shadowsocks 2022 Menu${NC} "
echo -e " ${MB}[3]${NC} ${YB}Trojan Menu${NC}         ${MB}[6]${NC} ${YB}Socks5 Menu${NC}           "
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo -e "                 ${WB}----- [ MORE SETTINGS ] -----${NC}                "
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo -e " ${MB}[7]${NC} ${YB}Log Create Account${NC}  ${MB}[11]${NC} ${YB}Change Xray-core Mod${NC}"
echo -e " ${MB}[8]${NC} ${YB}Speedtest${NC}           ${MB}[12]${NC} ${YB}Change Xray-core Official${NC}"
echo -e " ${MB}[9]${NC} ${YB}Change Domain${NC}       ${MB}[13]${NC} ${YB}About Script${NC}"
